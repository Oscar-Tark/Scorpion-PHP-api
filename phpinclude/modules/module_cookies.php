...
class Cookies
{
	...
	function cookie_dialog($text, $doc, $redirect_to, $redirect_website_name, $onaccept)
	{
		//Warning cookies will not be generated by this file, you will have to generate accepted cookies cookie on your own
		echo "<div class=\"cookies_background\" id=\"cookies_background\"><div class=\"cookies\" id=\"cookies\"><label>".$text." <a href=\"".$doc."\" target=\"new\"><label  class=\"cookies_learn\">Click here to learn more..</label></a></label><br><br><a href=\"".$onaccept."\"><button class=\"cookie_button\">I accept</button></a><a href=\"".$redirect_to."\"><button class=\"cookie_button\">I do not accept (This will send you to ".$redirect_website_name.")</button></a></div></div>";
		return;
	}
}
?>
